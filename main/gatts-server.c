...
#define GATTS_SERVICE_UUID_SOIL_MOISTURE 0x00DD
#define GATTS_CHAR_UUID_SOIL_MOISTURE 0xDD01
#define GATTS_NUM_HANDLE_SOIL_MOISTURE 2

#define GATTS_SERVICE_UUID_ILLUMINANCE 0x00CC
#define GATTS_CHAR_UUID_ILLUMINANCE 0xCC01
#define GATTS_NUM_HANDLE_ILLUMINANCE 2

#define GATTS_SERVICE_UUID_WIFI_STATUS 0x00BB
#define GATTS_CHAR_UUID_WIFI_STATUS 0xBB01
#define GATTS_NUM_HANDLE_WIFI_STATUS 2

#define TEST_MANUFACTURER_DATA_LEN 17

#define DEVICE_NAME "SMART_POWER_PLANT"
...
static esp_gatt_char_prop_t smart_plant_property = 0;

static esp_attr_value_t gatts_smart_plant_soil_moisture_val =
    {
...
static esp_attr_value_t gatts_smart_plant_illuminance_val =
    {
        .attr_max_len = GATTS_DEMO_CHAR_VAL_LEN_MAX,
        .attr_len = sizeof(char1_str),
        .attr_value = char1_str,
...
static esp_attr_value_t gatts_smart_plant_wifi_status_val =
    {
        .attr_max_len = GATTS_DEMO_CHAR_VAL_LEN_MAX,
        .attr_len = sizeof(char1_str),
        .attr_value = char1_str,
...
// modify it to different uuid to another ble device
...
#define PROFILE_SMART_PLANT_APP_ID 0

struct gatts_smart_plant_profile_inst
{
    esp_gatts_cb_t gatts_cb;
    uint16_t gatts_if;
    uint16_t app_id;
    uint16_t conn_id;
    uint16_t soil_service_handle;
    esp_gatt_srvc_id_t soil_service_id;
    uint16_t soil_char_handle;
    esp_bt_uuid_t soil_char_uuid;
    uint16_t illuminance_service_handle;
    esp_gatt_srvc_id_t illuminance_service_id;
    uint16_t illuminance_char_handle;
    esp_bt_uuid_t illuminance_char_uuid;
    uint16_t wifi_service_handle;
    esp_gatt_srvc_id_t wifi_service_id;
    uint16_t wifi_char_handle;
    esp_bt_uuid_t wifi_char_uuid;
    esp_gatt_perm_t soil_perm;
    esp_gatt_char_prop_t soil_property;
    esp_gatt_perm_t illuminance_perm;
    esp_gatt_char_prop_t illuminance_property;
    esp_gatt_perm_t wifi_perm;
...
static void gatts_smart_plant_profile_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    switch (event)
    {
    case ESP_GATTS_REG_EVT:
        ESP_LOGI(GATTS_TAG, "REGISTER_APP_EVT, status %d, app_id %d\n", param->reg.status, param->reg.app_id);
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].soil_service_id.is_primary = true;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].soil_service_id.id.inst_id = 0x00;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].soil_service_id.id.uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].soil_service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_SOIL_MOISTURE;

        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].illuminance_service_id.is_primary = true;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].illuminance_service_id.id.inst_id = 0x00;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].illuminance_service_id.id.uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].illuminance_service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_ILLUMINANCE;

        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].wifi_service_id.is_primary = true;
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].wifi_service_id.id.inst_id = 0x00;
...
#endif
        // create the soil service
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].soil_service_id, GATTS_NUM_HANDLE_SOIL_MOISTURE);
        // create the illuminance service
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].illuminance_service_id, GATTS_NUM_HANDLE_ILLUMINANCE);
        // create the wifi service
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].wifi_service_id, GATTS_NUM_HANDLE_WIFI_STATUS);
        break;
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        else if (para.create.service_id.uuid.uuid.uuid16 == GATTS_SERVICE_UUID_WIFI_STATUS)
        {
            ...
            gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].wifi_char_uuid.len = ESP_UUID_LEN_16;
    ...
    case ESP_GATTS_CONNECT_EVT:
    {
        ...
        gl_profile_tab[PROFILE_SMART_PLANT_APP_ID].conn_id = param->connect.conn_id;
